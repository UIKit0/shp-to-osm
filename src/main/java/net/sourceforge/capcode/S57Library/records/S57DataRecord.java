...
//	public S57DataRecord(S57ByteBuffer buffer, S57ModuleReader module) throws Exception {
//		super(buffer);
//		this.module = module;
//		readFields();
//	}
...
//			S57DDRDataDescriptiveField fieldDefinition = null;
...
//			}else{
//				System.err.println(String.format("field %s has no declared definion", tag));
//			}
			index += width;
		}
	}
