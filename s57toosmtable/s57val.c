...
s57val_t catlam[] = { {1, "port"}, {2, "starboard"}, {3, "preferred_channel_starboard"}, {4, "preferred_channel_port"}, {5, "waterway_left"}, {6, "waterway_right"}, {7, "channel_left"}, {8, "channel_right"},
